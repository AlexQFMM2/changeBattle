...
`0.1.31` 是当前 beta Desktop / Android debug 基线：Desktop zip 和 Android APK 挂 GitHub Release，线上 beta 服务器只发布 `latest.json / index.html / manifests / objects`。本轮只修 Web UI：starter 候选基础页展示 4 技能，训练场批量自习改为左右箭头步进；未改 API 服务端代码。
