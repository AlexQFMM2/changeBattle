...
0.1.34 debug  人工反馈热修：医疗保险、神战 NPC 过滤、训练/商店/排序/结算恢复和 Android debug APK 同步。
```
...
- `0.1.34` 继续沿用该策略，线上增量只发布 `latest.json / index.html / manifests / objects`；完整 Desktop zip 和 Android debug APK 指向 GitHub Release。
