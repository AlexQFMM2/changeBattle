/**
 * Pokemon Showdown icon index data.
 *
 * Extracted from pokemon-showdown-client/play.pokemonshowdown.com/src/battle-dex-data.ts.
 * Source license: MIT, author Guangcong Luo.
 */
