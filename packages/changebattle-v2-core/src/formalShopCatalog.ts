...
export const FORMAL_SHOP_ITEM_BASE_WEIGHTS: Record<string, number> = {
  ...
  choicespecs: 2,
  focussash: 1,
  ...Object.fromEntries(FORMAL_SHOP_EV_SMALL_ITEM_POOL.map(itemID => [itemID, 6])),
  ...Object.fromEntries(FORMAL_SHOP_EV_COMMON_ITEM_POOL.map(itemID => [itemID, 6])),
  ...Object.fromEntries(FORMAL_SHOP_EV_RESET_ITEM_POOL.map(itemID => [itemID, 5])),
