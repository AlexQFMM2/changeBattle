...
export function formalMoveQualityRuleForSourceV4(source: FormalMoveQualitySourceV4): FormalMoveQualityRuleV4 {
  if (source.kind === "player-starter") return {correctMoveCount: 1, preferPresetMoves: false};
  ...
  if (tier === "rookie" || tier === "normal") return {correctMoveCount: 2, preferPresetMoves: false};
