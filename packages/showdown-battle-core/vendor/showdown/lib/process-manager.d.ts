...
import { type EvalType } from './repl';
...
export declare class QueryProcessManager<T = string, U = string> extends ProcessManager<QueryProcessWrapper<T, U>> {
     ...
     */
    constructor(id: string, ctx: NodeJS.Module, query: (input: T) => U | Promise<U>, timeout?: number, debugCallback?: (message: string) => any);
...
export declare class StreamProcessManager extends ProcessManager<StreamProcessWrapper> {
    ...
    messageCallback?: (message: string) => any;
    constructor(id: string, ctx: NodeJS.Module, createStream: () => Streams.ObjectReadWriteStream<string>, messageCallback?: (message: string) => any);
