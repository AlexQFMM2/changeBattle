...
var PureEffect = /*#__PURE__*/_createClass(function PureEffect(id, name) {
  _classCallCheck(this, PureEffect);
  _defineProperty(this, "effectType", 'PureEffect');
  this.id = id;
  this.name = name;
  this.gen = 0;
  this.exists = false;
});
var Item = /*#__PURE__*/_createClass(function Item(id, name, data) {
  _classCallCheck(this, Item);
  // effect
  _defineProperty(this, "effectType", 'Item');
...
// side and field
var Move = /*#__PURE__*/_createClass(function Move(id, name, data) {
  var _this$maxMove;
  _classCallCheck(this, Move);
  // effect
  _defineProperty(this, "effectType", 'Move');
  if (!data || _typeof(data) !== 'object') data = {};
  if (data.name) name = data.name;
  this.name = Dex.sanitizeName(name);
  this.id = id;
  ...
  if (this.category !== 'Status' && !((_this$maxMove = this.maxMove) !== null && _this$maxMove !== void 0 && _this$maxMove.basePower)) {
...
var Ability = /*#__PURE__*/_createClass(function Ability(id, name, data) {
  _classCallCheck(this, Ability);
  // effect
  _defineProperty(this, "effectType", 'Ability');
  if (!data || _typeof(data) !== 'object') data = {};
  if (data.name) name = data.name;
  this.name = Dex.sanitizeName(name);
  this.id = id;
...
var Species = /*#__PURE__*/_createClass(
// name
...
function Species(id, name, data) {
  _classCallCheck(this, Species);
  // effect
  _defineProperty(this, "effectType", 'Species');
  if (!data || _typeof(data) !== 'object') data = {};
  if (data.name) name = data.name;
  this.name = Dex.sanitizeName(name);
  this.id = id;
