...
const officialSiteUrl = withTrailingSlash(options.officialSiteUrl || process.env.CHANGEBATTLE_OFFICIAL_SITE_URL || options.downloadPageUrl || process.env.CHANGEBATTLE_DOWNLOAD_PAGE_URL || "http://119.45.240.157/changebattle/");
