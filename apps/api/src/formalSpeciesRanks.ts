export type FormalPokemonSpeciesRankData = "rank1" | "rank2" | "rank3" | "rank4" | "rank5" | "rank6" | "legendary";

export type FormalPokemonSpeciesRankEntryData = {
  id: string;
  species: string;
  baseSpecies: string;
  rank: FormalPokemonSpeciesRankData;
  sourceTier: number;
  score: number;
};

export const FormalPokemonSpeciesRankEntries: FormalPokemonSpeciesRankEntryData[] = [
  {
    "id": "abomasnow",
    "species": "Abomasnow",
...
export const FormalPokemonSpeciesRankById: Record<string, FormalPokemonSpeciesRankData> = Object.fromEntries(FormalPokemonSpeciesRankEntries.map(entry => [entry.id, entry.rank]));
