import {formalGameModeLabelV4, type FormalGameRunV4} from "@changebattle-v2/api";
  ...
  return (
    <main className="formal-game-pending-page">
      <section className="formal-game-pending-panel">
        ...
        <h1>初始队伍已确认</h1>
        <p>{formalGameModeLabelV4(run.mode)} 已保存 {run.playerTeam?.pokemon.length || 0} 只首发宝可梦。</p>
