...
export function TrainingRestShopDialogue({speaker = "店员", text, itemName, actions = []}: TrainingRestShopDialogueProps) {
  return (
    <section className="training-rest-shop-dialogue" role="dialog" aria-label="商店商品介绍">
